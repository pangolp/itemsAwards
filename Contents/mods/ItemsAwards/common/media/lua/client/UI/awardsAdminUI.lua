...
local W       = 610
local H       = 460    -- extra height gives breathing room for status area
local PAD     = 12
local BTN_H   = 24
local FIELD_H = 24
local COL_SEP = 295
