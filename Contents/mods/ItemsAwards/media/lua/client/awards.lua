...
local itemsAwards = {
    {Item = "Base.BaseballBatNails", Number = 5, Count = 1, zkills = 500}, -- Spiked Baseball Bat
    ...
    {Item = "Base.Katana", Number = 25, Count = 1, zkills = 500}, -- Katana
    ...
    {Item = "Base.DoubleBarrelShotgun", Number = 55, Count = 1, zkills = 500}, -- Double Barrel Shotgun
    ...
    {Item = "Base.Jumper_DiamondPatternTINT", Number = 85, Count = 1, zkills = 500}, -- Diamond-pattern Sweater
    {Item = "Base.Jacket_Black", Number = 90, Count = 1, zkills = 2000}, -- Leather Jacket
    {Item = "Base.Apron_Spiffos", Number = 95, Count = 1, zkills = 500}, -- Spiffo's Server Apron
    {Item = "Base.TrousersMesh_Leather", Number = 100, Count = 1, zkills = 500}, -- Skinny Leather Trousers
    {Item = "Base.SpiffoSuit", Number = 105, Count = 1, zkills = 500}, -- Spiffo Suit
    ...
    {Item = "Base.Bag_ALICEpack_Army", Number = 145, Count = 1, zkills = 500}, -- Military Backpack
    ...
    {Item = "Base.CarBatteryCharger", Number = 165, Count = 1, zkills = 500}, -- Car Battery Charger
    {Item = "Base.WoodAxe", Number = 170, Count = 1, zkills = 3000}, -- Wood Axe
    {Item = "Base.BoxOfJars", Number = 175, Count = 1, zkills = 500}, -- Box of Jars
    ...
    {Item = "Radio.RadioMag1", Number = 210, Count = 1, zkills = 500}, -- Guerilla Radio Vol. 1
    {Item = "Radio.RadioMag2", Number = 215, Count = 1, zkills = 500}, -- Guerilla Radio Vol. 2
    {Item = "Radio.RadioMag3", Number = 220, Count = 1, zkills = 500}, -- Guerilla Radio Vol. 3
    ...
    {Item = "Base.PropaneTank", Number = 260, Count = 1, zkills = 500}, -- Propane Tank
